...
const ErrorPages = () => {
    ...
    return (
        <div className='flex flex-col gap-6 justify-center items-center h-[100vh]'>
            ...
            <Link to='/' className='text-xl md:text-2xl font-semibold text-white rounded-lg bg-gradient-to-r from-[#5756FD] to-[#D040F5] hover:bg-gradient-to-l hover:from-[#1313fa] hover:to-[#ce26f8] px-6 md:px-20 py-2 '>Go To Home Pages</Link>
        </div>
    );
};
